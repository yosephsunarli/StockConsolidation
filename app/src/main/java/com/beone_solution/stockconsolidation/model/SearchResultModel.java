...
public class SearchResultModel {
     ...
     * @param fromWhsCode
     */
    public SearchResultModel(String conID, String artNo, String fromWhsCode, String fromWhsName, String toWhsCode, String toWhsName, Double fromBQty, Double fromEQty, Double toBQty, Double toEQty) {
        super();
        this.conID = conID;
        this.artNo = artNo;
